...
<script>
    ...
    fetch('/app/api/product-detail.php?id=' + productId)
        ...
        .then(data => {
            ...
            document.getElementById('productPrice').textContent = `Giá: ${product.minPrice === product.maxPrice ? formatCurrency(product.minPrice) : formatCurrency(product.minPrice)} - ${formatCurrency(product.maxPrice)}`;
                ...
                <div class="col-md-3 product-col">
                    <div class="card product-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="price">${rp.minPrice === rp.maxPrice ? formatCurrency(rp.minPrice) : formatCurrency(rp.minPrice)} - ${formatCurrency(rp.maxPrice)}</p>
